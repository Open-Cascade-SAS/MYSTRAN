...
!     DGBTF2: to compute a LU factorization of a real m-by-n band matrix A using partial pivoting with row interchanges.
!             This subroutine is called by DGBTRF
...
! 001 LAPACK_LINEAR_EQN_DGB
      ...
      CHARACTER(LEN=LEN(BLNK_SUB_NAM)):: subr_name = 'DGBTRF'
*
...
*     .. Local Scalars ..
     ...
     $                   JU, K2, KM, KV, NB, NW
! /////////////////////////////////////////////////////////////////////B
! Add this so we can use IMPLICIT NONE  (switch "-in" when compiling)
      integer            numblk, iblock
! /////////////////////////////////////////////////////////////////////E
      REAL(DOUBLE)   TEMP
*     ..
*     .. Local Arrays ..
      REAL(DOUBLE)   WORK13( LDWORK, NBMAX ),
     $                   WORK31( LDWORK, NBMAX )
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
! 002 LAPACK_LINEAR_EQN_DGB
     ...
     $                   INFO, dtbsv_msg )   ! I added dtbsv_msg
      ...
      CHARACTER(LEN=LEN(BLNK_SUB_NAM)):: subr_name = 'DGBTRS'
*
*  -- LAPACK routine (version 3.0) --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
...
! 003 LAPACK_LINEAR_EQN_DGB
      ...
      CHARACTER(LEN=LEN(BLNK_SUB_NAM)):: subr_name = 'DGBTF2'
*
*  -- LAPACK routine (version 3.0) --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
